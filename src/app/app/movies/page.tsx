...
export default function MoviesPage() {
  ...
  if (!isClient || (isLoading && movies.length === 0)) {
    return (
      <div>
  ...
  return (
    <div className="space-y-10">
      <h1 className="text-3xl font-bold flex items-center mb-4"><Film className="mr-3 h-8 w-8 text-primary" /> Movies</h1>
      {isClient && isLoading && movies.length > 0 && <Progress value={progressValue} className="w-full mb-8 h-2" />}
